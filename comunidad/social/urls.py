...
urlpatterns = [
    ...
    path('comunidad/<int:comunidad_id>/campaigns/', views.lista_campaigns, name='lista_campaigns'),
    path('comunidad/<int:comunidad_id>/proyectos/', views.lista_proyectos, name='lista_proyectos'),
