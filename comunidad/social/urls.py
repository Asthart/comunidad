...
urlpatterns = [
    ...
    path('guardar-donacion/<slug>/', views.guardar_donacion, name='guardar_donacion'),
    path('chat-comunidad/<int:comunidad_id>/', views.chat_comunidad, name='chat_comunidad'),
    path('desafio/<slug:slug>/guardar-donacion/', views.guardar_donacion, name='guardar_donacion'),
